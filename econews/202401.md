...
- Version 1.1.0 of the Cryptopower multi-asset wallet (DCR, BTC, LTC) has been [released](https://github.com/crypto-power/cryptopower/releases/tag/v1.1.0).
- The major addition to this version is DCRDEX support for LTC/DCR and BTC/DCR trading pairs, which is considered to be under beta testing for this release.
- New options have been added to send transactions to multiple recipients in one go, and to export transaction details for record keeping.
- The user interface has been improved, including with an option to switch between mainnet/testnet from the settings page.
- Trocador has been added as an option for instant exchange functionality within the app.
...
- @tothemoon created [@Decred_Chinese](https://t.me/Decred_Chinese) channel on Telegram. As of writing it has { 28 } users.
}
