...
- Cryptopower v1.1.0 has been released for major desktop and mobile platforms, bringing roughly 6 months of work contributed by 13 developers and 3 designers. Cryptopower is a new multi-asset wallet for DCR, BTC, and LTC.

- Highlights of the release include: DCRDEX integration beta (DCR/BTC and DCR/LTC pairs), multi-recipient transactions, transaction export, accountless exchange of crypto via [Trocador.app](https://trocador.app/en/), and numerous UI/UX/design updates.
...
- Hardcore fans of the project can find the detailed list of changes in the [222 commits](https://github.com/crypto-power/cryptopower/compare/v1.0.0...v1.1.0) or [Decred Journal dev logs](https://xaur.github.io/decred-news/) for August-December 2023.
