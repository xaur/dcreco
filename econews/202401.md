...
- For extra safety users can try testnet builds first, also on [Google Play](https://play.google.com/store/apps/details?id=com.dreacotdigital.cryptopower.testnet) and [TestFlight](https://testflight.apple.com/join/T0oFuwoq).
