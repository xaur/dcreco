...
- A new communications bridge has been [created](https://matrix.to/#/!EXHLRfaYsLJbnAfECa:decred.org/$3kG86fqEmpDP_PUKjNcBosxjrQNwl-0orBTuJ1TISCE) between the @Decred channel on [Telegram](https://matrix.to/#/!EXHLRfaYsLJbnAfECa:decred.org/$3kG86fqEmpDP_PUKjNcBosxjrQNwl-0orBTuJ1TISCE) and the DCR 101 room on [Matrix](https://matrix.to/#/#101:decred.org).

- The #101 room is now the easiest chat to access since users from Matrix, Discord and Telegram can post and talk to each other. When Telegram was bridged the channel had 2.3k users, joining the ~400 in the Matrix 101 room.
...
- I tried to get access to Discord room inhabitants number but it wanted me to link reddit/twitter accounts to be verified and then failed to do so.
}
