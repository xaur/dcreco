...
- @tothemoon created [@Decred_Chinese](https://t.me/Decred_Chinese) channel on Telegram with { 28 } users as of writing. The channel is bridged to Chinese Discord and Matrix chats to connect more Chinese speakers in the same space. { find approx date, iirc ~01-25 via #101 }

- Poloniex fixed DCR? DROP if this unknown

- HTX fixed DCR or not? DROP this if unknown
