...
- SRBMiner v2.4.4 with DCR support and dual-mining [12-20]
  - https://github.com/doktor83/SRBMiner-Multi/releases/tag/2.4.4
  - MOVE to 202312.md OR find a better way to handle this
...
- @tothemoon created [@Decred_Chinese](https://t.me/Decred_Chinese) channel on Telegram with { 28 } users as of writing. The channel is bridged to Chinese Discord and Matrix chats to connect more Chinese speakers in the same space. { find approx date }

- Poloniex fixed DCR?

- HTX fixed DCR or not?
